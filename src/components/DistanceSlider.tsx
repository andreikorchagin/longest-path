  ...
  return (
    <div className="space-y-2">
      <div className="flex justify-between items-baseline">
        <label htmlFor={sliderId} className="text-sm text-zinc-500">
          Target distance
        </label>
        <span className="text-base font-bold text-zinc-800 tabular-nums" aria-live="polite">
      ...
      <input
        ...
        className="w-full h-2.5 bg-zinc-200 rounded-lg appearance-none cursor-pointer accent-blue-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
      />
      <div className="flex justify-between text-xs text-zinc-400" aria-hidden="true">
